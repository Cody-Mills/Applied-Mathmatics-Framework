...
HRESULT DX11PhysicsFramework::InitRunTimeData()
{
	...
	gameObject->GetTransform()->SetPosition(XMFLOAT3(0.0f, 0.0f, 0.0f));
	gameObject->GetTransform()->SetScale(XMFLOAT3(15.0f, 15.0f, 15.0f));
	gameObject->GetTransform()->SetRotation(XMFLOAT3(XMConvertToRadians(90.0f), 0.0f, 0.0f));
	...
	for (auto i = 0; i < 4; i++)
	{
		...
		gameObject->GetTransform()->SetScale(XMFLOAT3(1.0f, 1.0f, 1.0f));
		gameObject->GetTransform()->SetPosition(XMFLOAT3(-2.0f + (i * 2.5f), 1.0f, 10.0f));
	...
	gameObject->GetTransform()->SetScale(XMFLOAT3(1.0f, 1.0f, 1.0f));
	gameObject->GetTransform()->SetPosition(XMFLOAT3(-5.0f, 0.5f, 10.0f));
	gameObject->SetTextureRV(_StoneTextureRV);
	_gameObjects.push_back(gameObject);
